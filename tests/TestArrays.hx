...
class TestArrays extends TestBase {
  ...
  public function basics() {
    ...
    assert(getLog() == 'l:100,99:99');
    clear();

    for (i in 0...10)
      a.pop();

    assert(getLog() == 'l:99,99:-,l:98,l:97,l:96,l:95,l:94,l:93,l:92,l:91,l:90');
    clear();

    for (i in 0...9)
      a.unshift(a.get(0)-1);    
    
    assert(getLog() == 'l:91,l:92,l:93,l:94,l:95,l:96,l:97,l:98,l:99');

    clear();
    a.unshift(a.get(0)-1);    
    assert(getLog() == '99:89,l:100');//It's a good question why exactly this happens out of order
    clear();
    for (i in 0...10)
      a.push(i);
